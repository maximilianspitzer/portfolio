...
export const metadata: Metadata = {
  ...
  description: "Modern web applications and digital experiences with React, Next.js, and TypeScript. Professional web development services in Germany.",
  keywords: ["web development", "React", "Next.js", "TypeScript", "frontend", "full-stack", "UI/UX", "Germany"],
  ...
  openGraph: {
    ...
    description: "Modern web applications and digital experiences with React, Next.js, and TypeScript.",
    images: [
      {
        url: "/og.png",
        width: 1200,
